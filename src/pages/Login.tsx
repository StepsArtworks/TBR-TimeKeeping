    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 dark:bg-dark-900 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold">Welcome to TBR Time Keeping</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div className="text-center text-sm">
            ...
            <div className="mt-2 space-y-1">
              <p>Admin: admin@boilerroom.co.za / 1234TBRAdmin</p>
              <p>Management: management@boilerroom.co.za / 1234</p>
              <p>Lead: lead@boilerroom.co.za / 1234</p>
              <p>User 1: user1@boilerroom.co.za / 1234</p>
              <p>User 2: user2@boilerroom.co.za / 1234</p>
            </div>
          </div>
        </form>
      </div>
